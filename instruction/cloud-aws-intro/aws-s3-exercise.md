...
- Create a new typescript project for this exercise
    - **Note:** You can follow [these instructions](https://github.com/BYU-CS-340/softwaredesign/blob/main/instruction/typescript-fundamentals-1/standalone-typescript-project-setup-instructions.md) to setup a standalone TypeScript project
